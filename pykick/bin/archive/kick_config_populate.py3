...
if __name__ == '__main__':
    ...
    if len(sys.argv) != 3:
        print('Usage: kick_config_populate.py3 <CONFIG NAME> <NEW CONFIG NAME>')
        raise SystemExit(1)
    ...
    if not global_fk:
        print('config name ',globalname,' is broken.... Usage: kick_config_populate.py3 <CONFIG NAME> <NEW CONFIG NAME>')
        close_db(dbconn)
        raise SystemExit(1)
    else:
