      ...
      if($cisco_cab)
      {
         ...
         {  
            ...
            else
            {
               ...
               echo "<a class=\"racklayout\" title=\"View details for $rack_layout[$i]\" href=\"$url/html/encore_detail_view.php?hostname=$rack_layout[$i]&row=$dbrow[$c]&cab=$dbcab[$c]\" <strong>$rack_layout[$i]</strong></a></td></tr>\n";
            }
         }
      }
      else
